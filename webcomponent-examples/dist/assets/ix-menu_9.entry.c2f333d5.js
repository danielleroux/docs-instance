import { r as registerInstance, c as createEvent, b as H, h, H as Host, g as getElement, f as forceUpdate } from "./index.dc1a0ae3.js";
import { a as convertToRemString } from "./rwd.util-33a69d24.7b9a9bea.js";
class Popover {
...
const Menu = class {
  ...
  render() {
    ...
    }, title: "Show more", notifications: this.countMoreNotifications, onClick: () => this.toggleShowMoreDropdown() }, this.i18nMore, h("ix-dropdown", { show: this.showMoreItems }, this.menuItems.filter((elm, index) => !this.showTab(index) && !this.isMenuItemActive(elm) && this.isVisible(elm)).map((e) => {
